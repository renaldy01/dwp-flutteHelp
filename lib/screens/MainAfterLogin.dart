...
class MainAfterLogin extends StatefulWidget {
  ...
  MainAfterLogin({Key? key, required this.registeredFirstName})
      : super(key: key);
...
class _MainAfterLoginState extends State<MainAfterLogin> {
  late String _registeredFirstName; // Menyimpan nama depan yang diregistrasi
  late List<DoctorModel> filteredDoctors;

  @override
  void initState() {
    super.initState();
    _registeredFirstName = widget.registeredFirstName;
  ...
  BottomNavigationBar _bottomNavigationBar(BuildContext context) =>
      BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == menus.indexOf(Icons.person)) {
            // Ganti dengan pemanggilan navigasi ke ProfilPage
            Navigator.push(
              context,
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: "Cari dokter terbaik untuk vaksinasi, perawatan...",
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: const [
                        ...
                        TextSpan(text: "akan mendapatkan\nvaksinasi "),
                        TextSpan(
                          text: "besok \npukul 07.00 pagi!",
                          style: TextStyle(
                            color: Colors.white,
